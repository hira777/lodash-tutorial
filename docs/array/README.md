...
2. 第１引数の反復処理で生成された配列と第２引数以降の反復処理で生成された配列を比較する。
3. 第１引数の反復処理で生成された配列に、第２引数以降の反復処理で生成された配列に含まれない値があった場合、その値を返した反復処理の引数に渡されていた要素を格納した配列を返す。
